          ...
          >
            <Avatar className="h-32 w-32 md:w-48 md:h-48 rounded-full overflow-hidden">
              {image ? (
                ...
                <div
                  className={`uppercase h-32 w-32 md:h-48 md:w-48 text-5xl flex items-center justify-center rounded-full ${getColor(
                    selectedColor
                  )}`}
                >
                  {firstName
          ...
          <div className="flex min-w-32 md:min-w-64 flex-col gap-5 text-white items-center justify-center">
            ...
            <div className="w-full flex gap-5">
              {colors.map((color, index) => (
                <div
                  className={`${color} h-8 w-8 rounded-full cursor-pointer transition-all duration-300 ${selectedColor == index ? "outline-4 outline-white/50" : "ou"
                    }`}
                  key={index}
